...
module.exports = function(opts, theParams, generator, inspector){
  ...
  var myParams = Object.assign({}, defaultParams, params)
  ...
  function startSingle() {
    return new Promise(function(resolve, reject) {
      var socket = io.connect(options.socketUrl, options)
